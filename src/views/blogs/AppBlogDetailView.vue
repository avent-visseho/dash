                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <ul class="list-unstyled fw-medium px-2">
                                            <li><a href="javascript: void(0);"
                                                    class="text-dark pb-3 d-block border-bottom">Design<span
                                                        class="badge badge-soft-primary badge-pill ms-1 float-end font-size-12">02</span></a>
                                            </li>
                                            <li><a href="javascript: void(0);"
                                                    class="text-dark py-3 d-block border-bottom">Development <span
                                                        class="badge badge-soft-primary badge-pill float-end ms-1 font-size-12">04</span></a>
                                            </li>
                                            <li><a href="javascript: void(0);"
                                                    class="text-dark py-3 d-block border-bottom">Business<span
                                                        class="badge badge-soft-primary badge-pill ms-1 float-end font-size-12">12</span></a>
                                            </li>
                                            <li><a href="javascript: void(0);"
                                                    class="text-dark py-3 d-block border-bottom">Project<span
                                                        class="badge badge-soft-primary badge-pill ms-1 float-end font-size-12">08</span></a>
                                            </li>
                                            <li><a href="javascript: void(0);"
                                                    class="text-dark pt-3 pb-0 d-block">Travel<span
                                                        class="badge badge-soft-primary badge-pill ms-1 float-end font-size-12">10</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="mt-5">
                                        ...
                                        <div class="list-group list-group-flush">
                                            <a href="javascript: void(0);"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h5 class="font-size-13 text-truncate">Beautiful Day with Friends
                                                        </h5>
                                                        <p class="mb-0 text-truncate">20 August, 2022 <span class="">/ 05:00
                                                                AM</span></p>
                                                    </div>
                                                    <div class="fs-1">
                                            ...
                                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <p class="mb-0 text-truncate">20 August, 2022 <span class="">/ 05:05
                                                                AM</span></p>
                                                    </div>
                                                    <div class="fs-1">
                                                        <i class="mdi mdi-calendar"></i>
                                            ...
                                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h5 class="font-size-13 text-truncate">Project discussion with team
                                                        </h5>
                                                        <p class="mb-0 text-truncate">20 August, 2022 <span class="">/ 05:10
                                                                PM</span></p>
                                                    </div>
                                                    <div class="fs-1">
                                                        <i class="mdi mdi-calendar"></i>
                                            ...
                                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <p class="mb-0 text-truncate">20 August, 2022 <span class="">/ 05:30
                                                                PM</span></p>
                                                    </div>
                                                    <div class="fs-1">
                                                        <i class="mdi mdi-calendar"></i>
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="list-group list-group-flush">
                                            ...
                                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-3">
                                                        <img src="" alt="" class="avatar-xl h-auto d-block rounded">
                                                    </div>
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h5 class="font-size-13 text-truncate">Coffee with friends</h5>
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="px-2">
                                            <a href="#" class="font-size-17"><span
                                                    class="badge badge-soft-primary">Design</span></a>
                                            <a href="#" class="font-size-17"><span
                                                    class="badge badge-soft-primary">Development</span></a>
                                            <a href="#" class="font-size-17"><span
                                                    class="badge badge-soft-primary">Wordpress</span></a>
                                            <a href="#" class="font-size-17"><span
                                                    class="badge badge-soft-primary">HTML</span></a>
                                            <a href="#" class="font-size-17"><span
                                                    class="badge badge-soft-primary">Project</span></a>
                                            <a href="#" class="font-size-17"><span
                                                    class="badge badge-soft-primary">Business</span></a>
                                            <a href="#" class="font-size-17"><span
                                                    class="badge badge-soft-primary">Travel</span></a>
                                            <a href="#" class="font-size-17"><span
                                                    class="badge badge-soft-primary">Photography</span></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="gap-2 hstack flex-wrap px-2">
                                            ...
                                            <img src="" alt="" class="avatar-xl rounded">
