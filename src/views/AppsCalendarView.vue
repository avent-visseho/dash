                        ...
                        <div class="dropdown d-none d-sm-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                                    <img src="" alt="user-image" class="me-1"
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu" aria-expanded="false">
                                            ...
                                            <li><a href="apps-email-read.html" data-key="t-read-email">Read Email</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu" aria-expanded="false">
                                            ...
                                            <li><a href="apps-contacts-profile.html" data-key="t-profile">Profile</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="form-advanced.html" data-key="t-form-advanced">Advanced Plugins</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="tables-responsive.html" data-key="t-responsive-table">Responsive</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="icons-fontawesome.html" data-key="t-font-awesome">Font Awesome 5</a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <div class="card sidebar-alert border-0 text-center mx-4 mb-0 mt-5">
                            <div class="card-body">
                                ...
                                <div class="mt-4">
                                    ...
                                    <p class="font-size-13">Upgrade your plan from a Free trial, to select ‘Business
                                        Plan’.</p>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div id="external-events" class="mt-2">
                                                    ...
                                                    <div class="external-event fc-event text-success bg-soft-success"
                                                        ...
                                                        <i
                                                            class="mdi mdi-checkbox-blank-circle font-size-11 me-2"></i>New
                                                        Event Planning
                                                    </div>
                                                    ...
                                                    <div class="external-event fc-event text-dark bg-soft-dark"
                                                        data-class="bg-dark">
                                                        <i
                                                            class="mdi mdi-checkbox-blank-circle font-size-11 me-2"></i>Team
                                                        Meeting
                                                    </div>
                                                </div>
